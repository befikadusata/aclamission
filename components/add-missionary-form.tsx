...
interface AddMissionaryFormProps {
  partnerId: string
  onSuccess?: () => void
  onCancel?: () => void
}

export function AddMissionaryForm({ partnerId, onSuccess, onCancel }: AddMissionaryFormProps) {
    ...
    try {
      ...
      if (selectedPhoto) {
        ...
        if (!photoUrl) {
          toast({
            title: "Warning",
            description: "Photo upload failed, but missionary will be created without photo",
          })
        }
      }

      // Create missionary record
      ...
      toast({
        title: "Success",
        description: "Missionary has been added successfully.",
      })
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="flex gap-4 justify-end">
        ...
        <Button type="submit" disabled={isLoading}>
          {isLoading ? "Adding Missionary..." : "Add Missionary"}
        </Button>
      </div>
    </form>
  )
